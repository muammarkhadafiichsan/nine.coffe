                ...
                <div class="row">
                  <div class="span3">
                    <div class="post-image">
                      <a href="halaman_berita1.html"><img src="<?php echo base_url() . "assets/" . $i['foto']; ?>" height="750px" width="850px" /></a>
                    </div>
                  </div>
                  <div class="span5">
                    <ul class="post-meta">
                      <li class="first"><i class="icon-calendar"></i><span><?php echo $i['tanggal']; ?></span></li>
                      <li class="first"><i class="icon-calendar"></i><span><?php echo $i['nama_pengirim']; ?></span></li>
                    ...
                    <a href="<?php echo base_url() . "index.php/welcome/halaman_berita1/" . $i['id']; ?>" class="btn btn-block btn-success">Baca Selengkapnya</a>
                  </div>
                </div>
              </article>
            <?php } ?>
            ...
            <aside>
              <div class="widget">
                <form class="form-search" action="" method="get">
                  <input placeholder="Search...." type="text" name="key" class="input-medium search-query" value="<?php echo (isset($_GET['key'])) ? $_GET['key'] : "" ?>">
