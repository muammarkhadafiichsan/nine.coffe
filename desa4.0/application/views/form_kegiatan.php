        ...
        <div class="col-md-12">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-grey">
              ...
              <h4 class="widget-user-desc">Tambah Kegiatan</h4>
            </div>
...
<form role="form" action="<?php echo base_url()."welcome/add_kegiatan" ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="col-md-6">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="8"  placeholder="Deskripsi . . . . . . . . " name="deskripsi"></textarea>
                </div>
