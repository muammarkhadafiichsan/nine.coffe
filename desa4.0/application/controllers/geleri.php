...
<head>
  <meta charset="utf-8">
  <title>Dinas Petanian Bondowoso</title>
  <link rel="shortcut icon" type="text/css" href="<?php echo base_url(). "assets/template/front/Serenity/assets/img/logo.jpg"; ?>"
      ...
      <div class="row">
        <div class="span12">
          <ul class="filter">
            ...
            <li class="web"><a href="#" class="btn btn-color">Padi</a></li>
            <li class="brand"><a href="#" class="btn btn-color">Kopi</a></li>
            <li class="graphic"><a href="#" class="btn btn-color">Pengembangan teknologi</a></li>
          </ul>
        </div>
      </div>
      <div class="row">
            ...
            <div class="span6">
              <div class="thumbnail">
                <div class="image-wrapp">
                  ...
                  <article class="da-animate da-slideFromRight" style="display: block;">
                    <h4>Mengembangkan sektor pertanian kopi</h4>
                    <a href="portfolio-detail.html"><i class="icon-rounded icon-48 icon-link"></i></a>
                    <span><a class="zoom" data-pretty="prettyPhoto" href="assets/img/dummies/big1.jpg">
						<i class="icon-rounded icon-48 icon-zoom-in"></i>
						</a></span>
