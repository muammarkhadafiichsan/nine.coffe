...
<script src="<?= base_url('assets10/'); ?>vendors/nice-select/jquery.nice-select.min.js"></script>
<script src="<?= base_url('assets10/'); ?>vendors/jquery.ajaxchimp.min.js"></script>
<script src="<?= base_url('assets10/'); ?>vendors/mail-script.js"></script>
<script src="<?= base_url('assets10/'); ?>js/main.js"></script>
</body>