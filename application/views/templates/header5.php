...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="<?= base_url('assets6/'); ?>css/icomoon.css">
    <!-- Bootstrap  -->
  

    <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?= base_url('assets6/'); ?>css/magnific-popup.css">

    <!-- Flexslider  -->
    <link rel="stylesheet" href="<?= base_url('assets6/'); ?>css/flexslider.css">
    ...
    <!-- Modernizr JS -->
    <script src="<?= base_url('assets6/'); ?>js/modernizr-2.6.2.min.js"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
